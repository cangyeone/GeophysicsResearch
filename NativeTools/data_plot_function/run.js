!function(t){function e(i){if(n[i])return n[i].exports;
    ...
    ([function(t,e,n){t.exports=n(3)},,,function(module,exports){
...
var e=t.getOption();
if(_windowTopOrigin){var n={series:[]};
try{n=JSON.stringify(e)}catch(i)
{console.error(i)}window.top.postMessage({action:"optionUpdated",computedOption:n},_windowTopOrigin)}}function _wrapEChartsSetOption(t){
var e=t.setOption;
t.setOption=function(){
var n=e.apply(t,arguments);
return clearTimeout(syncBackTimeout),syncBackTimeout=setTimeout(
function(){syncBackOption(t)},2e3),n}}
function _wrapOnMethods(t){
var e=t.on;t.on=function(n){
var i=e.apply(t,arguments);
return _events.push(n),i}}
function _clearChartEvents(){
_events.forEach(function(t){if(myChart)myChart.off(t);
else for(var e=0;e<myCharts.length;++e)myCharts[e].off(t)}),_events.length=0}
